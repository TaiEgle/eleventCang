...
>
  <!-- <el-menu-item index="1">处理中心</el-menu-item> -->
    ...
    <ul class="top-right">
        ...
        <li v-show="planA" @click="toReg">免费注册</li>
        <li>个人中心</li>
        <li @click="ToShopCart">我的购物车</li>
        <li @click="ToAdmin('http://150.158.156.252:8080')">管理员通道</li>
        <li>联系客服</li>
        <li>网站导航</li>
    </ul> 
</el-menu>
...
<div class="head">
    ...
    <div class="shop">
        ...
        <el-button class="shopCar" @click="ToShopCart"><i class="el-icon-shopping-cart-2"></i>购物车</el-button>
        </el-badge>
    </div>
</div>
<div class="main">
...
import {getShopCart} from '@/request/api'
    export default {
        inject:['reload'],
        data() {
            return {
        ...
        created() {
            ...
            .then((res) => {
                // console.log(res);
                this.shopCarCount=res.data.length;
            }).catch((err) => {
                console.log(err);
            });
        },
